...
enum class MediaItemType {
    LOCAL_VIDEO, LOCAL_IMAGE, YOUTUBE_LINK, TIKTOK_LINK, FACEBOOK_LINK, ONLINE_VIDEO, ONLINE_IMAGE, GENERIC_LINK
}
...
fun MediaItem.typeName(): String = when (this) {
    ...
    is MediaItem.TikTokLink -> "TIKTOK_LINK"
    is MediaItem.FacebookLink -> "FACEBOOK_LINK"
